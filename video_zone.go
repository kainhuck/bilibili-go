...
type VideoZoneGroup struct {
	group map[int]VideoZone
}

// DougaGroup 动画分区
var DougaGroup = VideoZoneGroup{group: map[int]VideoZone{
	1:   {"动画(主分区)", "dougua", 1, "", "/v/douga"},
...
// AnimeGroup 番剧分区
var AnimeGroup = VideoZoneGroup{group: map[int]VideoZone{
	13:  {"番剧(主分区)", "anime", 13, "", "/anime"},
...
// GuochuangGroup 国创分区
var GuochuangGroup = VideoZoneGroup{group: map[int]VideoZone{
	167: {"国创(主分区)", "guochuang", 167, "", "/guochuang"},
...
// MusicGroup 音乐分区
var MusicGroup = VideoZoneGroup{group: map[int]VideoZone{
	3:   {"音乐(主分区)", "music", 3, "", "/v/music"},
...
// DanceGroup 舞蹈分区
var DanceGroup = VideoZoneGroup{group: map[int]VideoZone{
	129: {"舞蹈(主分区)", "dance", 129, "", "/v/dance"},
...
// GameGroup 游戏分区
var GameGroup = VideoZoneGroup{group: map[int]VideoZone{
	4:   {"游戏(主分区)", "game", 4, "", "/v/game"},
...
// KnowledgeGroup 知识分区
var KnowledgeGroup = VideoZoneGroup{group: map[int]VideoZone{
	36:  {"知识(主分区)", "knowledge", 36, "", "/v/knowledge"},
...
// TechGroup 科技分区
var TechGroup = VideoZoneGroup{group: map[int]VideoZone{
	188: {"科技(主分区)", "tech", 188, "", "/v/tech"},
...
// SportsGroup 运动分区
var SportsGroup = VideoZoneGroup{group: map[int]VideoZone{
	234: {"运动(主分区)", "sports", 234, "", "/v/sports"},
...
// CarGroup 汽车分区
var CarGroup = VideoZoneGroup{group: map[int]VideoZone{
	223: {"汽车(主分区)", "car", 223, "", "/v/car"},
...
// LifeGroup 生活分区
var LifeGroup = VideoZoneGroup{group: map[int]VideoZone{
	160: {"生活(主分区)", "life", 160, "", "/v/life"},
...
// FoodGroup 美食分区
var FoodGroup = VideoZoneGroup{group: map[int]VideoZone{
	211: {"美食(主分区)", "food", 211, "", "/v/food"},
...
// AnimalGroup 动物圈分区
var AnimalGroup = VideoZoneGroup{group: map[int]VideoZone{
	217: {"动物圈(主分区)", "animal", 217, "", "/v/animal"},
...
// KichikuGroup 鬼畜分区
var KichikuGroup = VideoZoneGroup{group: map[int]VideoZone{
	119: {"鬼畜(主分区)", "kichiku", 119, "", "/v/kichiku"},
...
// FashionGroup 时尚分区
var FashionGroup = VideoZoneGroup{group: map[int]VideoZone{
	155: {"时尚(主分区)", "fashion", 155, "", "/v/fashion"},
...
var InformationGroup = VideoZoneGroup{group: map[int]VideoZone{
	202: {"资讯(主分区)", "information", 202, "", "/v/information"},
...
// EntGroup 娱乐分区
var EntGroup = VideoZoneGroup{group: map[int]VideoZone{
	5:   {"娱乐(主分区)", "ent", 5, "", "/v/ent"},
...
// CinephileGroup 影视分区
var CinephileGroup = VideoZoneGroup{group: map[int]VideoZone{
	181: {"影视(主分区)", "cinephile", 181, "", "/v/cinephile"},
...
var DocumentaryGroup = VideoZoneGroup{group: map[int]VideoZone{
	177: {"纪录片(主分区)", "documentary", 177, "", "/documentary"},
...
// MovieGroup 电影分区
var MovieGroup = VideoZoneGroup{group: map[int]VideoZone{
	23:  {"电影(主分区)", "movie", 23, "", "/movie"},
...
// TvGroup 电视剧分区
var TvGroup = VideoZoneGroup{group: map[int]VideoZone{
	11:  {"电视剧(主分区)", "tv", 11, "", "/tv"},
